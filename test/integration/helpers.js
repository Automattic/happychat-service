...
export const authenticators = ( customer, operator, agent ) => {
	const customerAuthenticator = ( socket, callback ) => {
		callback( null, customer );
	};
	const agentAuthenticator = ( socket, callback ) => callback( null, agent );
	const operatorAuthenticator = ( socket, callback ) => callback( null, operator );
